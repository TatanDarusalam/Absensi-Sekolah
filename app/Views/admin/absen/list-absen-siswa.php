                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value) : ?>
                        ...
                        <tr>
                            ...
                            <td><?= $value['validasi'] == 'off' ? '<button type="button" class="btn btn-danger" onclick="validasiKehadiran(' . $value['id_presensi'] . ', \'on\')">Belum Tervalidasi</button>' : '<button type="button" class="btn btn-success" onclick="validasiKehadiran(' . $value['id_presensi'] . ', \'off\')">Kehadiran Tervalidasi</button>' ?></td>
