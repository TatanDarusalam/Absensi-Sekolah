...
<div class="content">
    <div class="container-fluid">
        ...
        <?php
            $siswaClass = 'col-lg-6 col-md-6 col-sm-6';
            $guruClass = 'col-lg-4 col-md-6 col-sm-6';
            $kelasClass = 'col-lg-6 col-md-6 col-sm-6';
            $petugasClass = 'col-lg-4 col-md-6 col-sm-6';
            $dataAbsenGuru = 'col-md-6';
            $dataAbsenSiswa = 'col-md-12';

            if (user()->toArray()['is_superadmin'] != '1' && user()->toArray()['is_superadmin'] != '0') 
            {
                // Hide Petugas card
                $petugasClass = 'd-none';
            } 
            ...
            {
                $siswaClass = 'col-lg-3 col-md-6 col-sm-6';
                $guruClass = 'col-lg-3 col-md-6 col-sm-6';
                $kelasClass = 'col-lg-3 col-md-6 col-sm-6';
                $petugasClass = 'col-lg-3 col-md-6 col-sm-6';
                $dataAbsenSiswa = 'col-md-6';
            }
            if (user()->toArray()['is_superadmin'] == '3')
            {
                $dataAbsenSiswa = 'col-md-6';
                $siswaClass = 'col-lg-4 col-md-6 col-sm-6';
                $kelasClass = 'col-lg-4 col-md-6 col-sm-6';
            }
        ?>
        <div class="row">
            <div class="<?= $siswaClass; ?>">
            ...
            <?php if (user()->toArray()['is_superadmin'] != '2') : ?>
                <div class="<?= $guruClass; ?>">
                    <div class="card card-stats">
            ...
            <!-- Jika user superadmin, tampilkan jumlah petugas -->
            <?php if (user()->toArray()['is_superadmin'] == '1' || user()->toArray()['is_superadmin'] == '0') : ?>
            <div class="<?= $petugasClass; ?>">
                <div class="card card-stats">
