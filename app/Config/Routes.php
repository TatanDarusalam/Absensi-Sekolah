...
$routes->group('admin', function (RouteCollection $routes) {
   ...
   $routes->post('absen-siswa/validasi-kehadiran', 'Admin\DataAbsenSiswa::validasiKehadiran'); // validasi kehadiran siswa
   ...
   $routes->post('absen-guru/validasi-kehadiran', 'Admin\DataAbsenGuru::validasiKehadiran'); // validasi kehadiran guru
