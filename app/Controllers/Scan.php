         ...
         case TipeUser::Guru:
            ...
            case TipeUser::Siswa:
               ...
               if ($sudahAbsen == true) {
                  ...
                  // return $this->showErrorView('Anda sudah absen hari ini', $data);
                  return "<br>Anda sudah absen masuk hari Ini"; die();
               }
               ...
               // return view('scan/scan-result', $data);
               return "Anda Sudah Berhasil Absen Masuk <br><br> Jam Masuk: " . $data['presensi']['jam_masuk'];
   ...
   public function absenPulang($type, $result)
   {
      ...
      switch ($type) {
         ...
         case TipeUser::Siswa:
            ...
            // return view('scan/scan-result', $data);
            return "Anda Sudah Berhasil Absen Pulang <br><br> Jam Pulang: " . $data['presensi']['jam_keluar'];
         default:
            return $this->showErrorView('Tipe tidak valid');
      }
   }
